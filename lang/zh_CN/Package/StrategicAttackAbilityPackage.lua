...
return {
    ...
    ['LuaMouLiangzhu'] = '良助',
    [':LuaMouLiangzhu'] = '蜀势力技，出牌阶段限一次，你可以将其他角色装备区内的一张牌置于你的武将牌上，称为“妆”，然后令拥有“助”标记的角色选择回复一点体力或摸两张牌',
    ['@LuaMouLiangzhu'] = '助',
    ...
    ['luamouliangzhu'] = '良助',
    ['LuaMouJieyin'] = '结姻',
    [':LuaMouJieyin'] = '使命技，①游戏开始时，你令一名其他角色获得“助”标记；\
    ...
    ['LuaMouXiaoji'] = '枭姬',
    [':LuaMouXiaoji'] = '吴势力技，当你失去装备区里的一张牌时，你摸两张牌，然后你可以弃置场上的一张牌',
