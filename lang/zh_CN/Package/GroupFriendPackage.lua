...
return {
    ...
    ['#Fuhua'] = '憨态',
    ['LuaGeidian'] = '给点',
    [':LuaGeidian'] = '<font color = "green"><b>出牌阶段每名角色限一次</b></font>，你可以令一名其他角色交给你一张牌\
    ...
    ['#SPFuhua'] = '憨态Plus',
    ['LuaYangjing'] = '养精',
    [':LuaYangjing'] = '锁定技，出牌阶段结束时，若你未于此阶段使用过【杀】，或当你的一张【杀】被弃置后，你获得一枚“精”标记；你的攻击距离和【杀】造成的伤害+X。你的【杀】结算完毕后，移除所有“精”标记',
    ['LuaTuci'] = '突刺',
    [':LuaTuci'] = '锁定技，当你使用【杀】指定目标后，若你与该角色的距离小于你的攻击范围，则此【杀】无视目标角色的防具且目标角色不能使用【闪】响应此【杀】\
    ...
    ['LuaJiaoxie'] = '缴械',
    ['draw1'] = '摸一张牌',
    [':LuaJiaoxie'] = '当你受到有来源的伤害后，若伤害来源没有被“缴械”，你可以将其所有装备移出游戏，然后废除其装备区。若该角色处于出牌阶段，所有结算结束后该角色结束出牌阶段\
    该角色的下一个回合开始时，其恢复装备区，然后将移出的牌置入装备区',
    ['LuaShulian'] = '熟练',
    ...
    ['#Anan'] = '榨汁姬',
    ['LuaZhazhi'] = '榨汁',
    [':LuaZhazhi'] = '其他角色的出牌阶段开始时，若你在该角色的攻击范围内，你可以令其对你使用一张不计入出牌阶段使用次数的杀（无距离限制）\
    若该杀未对你造成伤害，你摸一张牌并回复一点体力；否则该角色造成的伤害-1直到回合结束',
