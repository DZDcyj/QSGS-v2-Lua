...
return {
    ...
    ['#Cactus'] = '海呐百川',
    ['LuaBaipiao'] = '白嫖',
    [':LuaBaipiao'] = '锁定技，当你的牌不因使用、打出、重铸、主动给出、更换装备而失去时：若该牌被其他人获得，你摸一张牌，否则你获得一名角色区域内的一张牌',
    ...
    ['#SPRinsan'] = '工口上手',
    ['LuaQingyu'] = '情欲',
    [':LuaQingyu'] = '锁定技，出牌阶段，你使用牌没有距离与次数限制；当你于出牌阶段造成伤害后，你需执行以下一项：1.若你的手牌上限大于0，你可以令你本回合的手牌上限-1，然后摸一张牌；2.令本回合手牌上限+1',
    ['LuaJiaoxie'] = '缴械',
