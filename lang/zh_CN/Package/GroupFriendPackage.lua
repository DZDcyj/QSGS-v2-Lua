...
return {
    ...
    ['luaduzhan'] = '督战',
    ['LuaMianli'] = '勉励',
    [':LuaMianli'] = '每回合限一次，一名角色的出牌阶段开始时，你可以展示并交给其一张牌，然后令其选择一项整肃。弃牌阶段结束时，若其整肃成功，其选择一项整肃奖励获得并在结束阶段结束时执行一个额外的出牌阶段',
    ['LuaMianliRectification'] = '勉励整肃',
    ['@LuaMianli-Give'] = '你可以交给 %src 一张牌，令其执行一项整肃',
    ['LuaQinggong'] = '请功',
