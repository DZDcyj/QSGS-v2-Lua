...
return {
    ...
    ['#Fuhua'] = '憨态',
    ['LuaGeidian'] = '给点',
    [':LuaGeidian'] = '出牌阶段每名角色各限一次，你可以令一名其他角色交给你一张牌\
    当你于此阶段发动“给点”超过X次时，该角色视为对你使用一张杀（X为你失去的体力值且至少为1）',
    ['@LuaGeidian-ask'] = '请选择一张牌交给 %src，或点击“取消”给出随机一张牌',
    ['luageidian'] = '给点',
    ['LuaWanneng'] = '万能',
    [':LuaWanneng'] = '每回合限一次，你可以视为使用/打出一张基本牌或非延时类锦囊，或视为重铸一张【铁索连环】',
    ['luawanneng'] = '万能',
    ['wanneng_slash'] = '万能',
    ['wanneng_saveself'] = '万能',
    ['Rinsan'] = '磷酸',
    ...
    ['LuaSoutu'] = '搜图',
    [':LuaSoutu'] = '其他角色的出牌阶段限一次，该角色可以交给你一张手牌，然后你观看牌堆顶的3张牌，获得与此牌类型/点数/花色一致的牌\
    然后你可以将任意数量的手牌交给该角色',
    ['LuaSoutuVS'] = '搜图',
    [':LuaSoutuVS'] = '出牌阶段限一次，你可以交给其一张手牌，然后其观看牌堆顶的3张牌，获得与此牌类型/点数/花色一致的牌，然后将任意牌交给你',
    ['luasoutu'] = '搜图送牌',
    ...
    ['#SPCactus'] = '心狠手辣',
    ['LuaNosJuesha'] = '绝杀',
    [':LuaNosJuesha'] = '当一名角色在濒死结算期间第一次成为【桃】或【酒】的目标时，你可以令该【桃】或【酒】失效。若你于回合外发动此技能，则技能失效直到你的下一个回合开始',
    ['LuaJuesha'] = '绝杀',
    [':LuaJuesha'] = '每回合限一次，自己的回合无次数限制，当一名角色进入濒死时，你可以发动此技能，令第一张目标含有该角色的【桃】或【酒】失效',
    ['LuaMouhai'] = '谋害',
    ...
    ['#Erenlei'] = '哔哔机',
    ['LuaXunxin'] = '寻衅',
    [':LuaXunxin'] = '出牌阶段，你可以与其他角色拼点，你的拼点牌本次点数-X，赢的角色视为对没赢的角色使用一张无次数限制、不计入次数且无视防具的杀（X为本回合你因此技能造成伤害和发动此技能拼点赢的次数之和）',
    ['luaxunxin'] = '寻衅',
    ['#LuaXunxin'] = '%from 的 %arg 被触发，拼点值变为 %arg2',
    ['LuaChutou'] = '出头',
    [':LuaChutou'] = '锁定技，当你的牌不因发动此技能、更换装备、重铸、回合内使用或打出而失去时，你摸一张牌；当你摸牌后手牌数为全场唯一最多时，你弃置一张牌',
    ['Yaoyu'] = '西行寺妖羽',
    ['&Yaoyu'] = '妖羽',
    ['#Yaoyu'] = '孤星',
    ['LuaYingshi'] = '影噬',
    ...
    ['#Ajie'] = '嘉心糖',
    ['LuaJiaren'] = '嘉人',
    [':LuaJiaren'] = '锁定技，当你成为其他角色使用杀的目标时，你进行一次判定，若结果花色与该杀相同，取消之',
    ['LuaFabing'] = '发病',
    ...
    ['LuaZhiyuan'] = '支援',
    [':LuaZhiyuan'] = '每回合各限一次，准备阶段与结束阶段，你可以令任意名手牌数不大于体力值的角色各摸1张牌，或令一名手牌数大于体力值的角色回复1点体力',
    ['luazhiyuan'] = '支援',
    ...
    ['#Zhongliao'] = '指点江山',
    ['LuaRuiping'] = '锐评',
    [':LuaRuiping'] = '出牌阶段限两次，你可以随机一个技能（随机前可令其中一个技能随机到的概率翻倍），然后令一名本回合内未以此法获得过技能，且没有该技能的角色获得此技能直到你的下个回合结束。\
    可以随机到的技能有：仇海、恃勇、败家、英姿（新）、醉酒（boss战）',
    ['#LuaRuiping'] = '%from 随机到了技能“%arg”',
    ['luaruiping'] = '锐评',
    ['LuaJiuwen'] = '纠问',
    [':LuaJiuwen'] = '准备阶段，你可以依次弃置任意名角色各一张牌；结束阶段，你摸X张牌并交给这些角色中本回合内未受到伤害的角色各一张牌（X为准备阶段你以此法选择的角色数）',
    ['luajiuwen'] = '纠问',
    ...
    ['#Mikang'] = '督军',
    ['LuaDuzhan'] = '督战',
    [':LuaDuzhan'] = '出牌阶段限一次，你可以将一张牌交给一名其他角色，该角色需对你指定的另一名角色使用一张杀，否则你获得其一张牌，并视为对其使用一张无距离与次数限制且不计入次数的杀',
    ['LuaDuzhanChooseSlashTarget'] = '请选择一名 %src 以外的角色作为【杀】的目标',
    ['@LuaDuzhanSlashTo'] = '%src 对你发动了“督战”，请对 %dest 使用一张【杀】',
    ['luaduzhan'] = '督战',
    ['LuaLixing'] = '励行',
    [':LuaLixing'] = '每回合限一次，一名角色的出牌阶段开始时，你可以展示并交给其一张牌，然后令其选择一项整肃。弃牌阶段结束时，若其整肃成功，其选择一项整肃奖励获得并在结束阶段结束时执行一个额外的出牌阶段',
    ['LuaLixingRectification'] = '励行整肃',
    ['@LuaLixing-Give'] = '你可以交给 %src 一张牌，令其执行一项整肃',
    ['LuaQinggong'] = '请功',
    [':LuaQinggong'] = '当一名角色于其摸牌阶段外一次性获得至少两张牌时，或于其出牌阶段外回复体力时，你可以摸一张牌',
}
