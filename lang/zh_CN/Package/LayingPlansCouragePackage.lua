...
return {
    ...
    ['#ExSunyi'] = '骁悍激躁',
    ['LuaZaoli'] = '躁厉',
    [':LuaZaoli'] = '锁定技，出牌阶段，你不能使用或打出非本回合内进入手牌区的手牌；\
    ...
    ['LuaQuedi'] = '却敌',
    ['luaquedi'] = '却敌',
    [':LuaQuedi'] = '每回合限一次，当你使用【杀】或【决斗】指定唯一目标后，你可以选择一项：\
    1.获得其一张手牌；\
    2.弃置一张基本牌，然后此【杀】或【决斗】伤害+1；\
    背水：你减1点体力上限',
    ['LuaQuedi_ask'] = '你可以发动“却敌”',
    ['~LuaQuedi'] = '选择一名其他角色/选择一张基本牌→点击“确定”',
    ['LuaQuediBeishui'] = '你发动了“却敌”，可再弃置一张基本牌执行背水效果：令此牌伤害+1并失去一点体力上限',
    ['LuaChuifeng'] = '椎锋',
    ['luachuifeng'] = '椎锋',
    [':LuaChuifeng'] = '魏势力技，出牌阶段限两次，你可以失去一点体力，视为使用一张【决斗】。\
    当你受到此【决斗】的伤害时，你防止此伤害，然后此技能于此阶段内失效',
    ['#LuaChuifeng'] = '%from 的“%arg”被触发，防止了 %card 带来的伤害',
    ['LuaChongjian'] = '冲坚',
    ['luachongjian'] = '冲坚',
    [':LuaChongjian'] = '吴势力技，你可以将一张装备牌当【酒】或无距离限制且无视目标防具的【杀】使用。\
    ...
    ['#ExWangshuang'] = '边城猛兵',
    ['LuaYiyong'] = '异勇',
    [':LuaYiyong'] = '当你受到其他角色使用【杀】造成的伤害后，若你的装备区里有武器牌，你可以获得此【杀】，然后将此【杀】当【杀】对其使用（若其装备区里没有武器牌，此【杀】对其造成的伤害+1）',
    ['LuaShanxie'] = '擅械',
    [':LuaShanxie'] = '①出牌阶段限一次，你可以获得牌堆中的一张武器牌（若牌堆中没有武器牌，则改为随机获得一名其他角色装备区的武器牌）；\
    ②当你使用【杀】指定一名角色为目标后，该角色需使用点数大于你攻击范围两倍的【闪】才能抵消',
    ['luashanxie'] = '擅械',
