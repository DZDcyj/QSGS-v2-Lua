...
return {
    ...
    ['LuaJiushi'] = '酒诗',
    [':LuaJiushi'] = '当你需要【酒】时，若你的武将牌正面向上，你可以翻面视为使用一张【酒】，若你的武将牌背面朝上时你受到伤害，你可以翻面并获得牌堆中的一张随机锦囊',
    [':LuaJiushi2'] = '当你需要【酒】时，若你的武将牌正面向上，你可以翻面视为使用一张【酒】，若你的武将牌背面朝上时你受到伤害，你可以翻面；当你翻面时，你获得牌堆中的一张锦囊',
    ['LuaChengzhang'] = '成章',
