...
return {
    ...
    ['#ExStarGanning'] = '铃震没羽',
    ['LuaJinfan'] = '锦帆',
    [':LuaJinfan'] = '弃牌阶段开始时，你可以将任意张手牌置于武将牌上，称为“铃”（每种花色的“铃”至多各一张）。当你需要使用或打出手牌时，你可以将“铃”视为你的牌使用或打出；当你的“铃”离开你的武将牌上时，你从牌堆中获得一张花色相同的牌',
    ['luajinfan'] = '锦帆',
    ['&luajinfanpile'] = '铃',
    ...
    ['LuaJiushi'] = '酒诗',
    [':LuaJiushi'] = '当你需要【酒】时，若你的武将牌正面向上，你可以翻面视为使用一张【酒】，当你受到伤害后若你武将牌背上向上，你可以翻面并获得牌堆中的一张随机锦囊',
    [':LuaJiushi2'] = '当你需要【酒】时，若你的武将牌正面向上，你可以翻面视为使用一张【酒】，当你受到伤害后若你武将牌背上向上，你可以翻面；当你翻面时，你获得牌堆中的一张锦囊',
    ['LuaChengzhang'] = '成章',
    ...
    ['#JieXunyu'] = '王佐之才',
    ['LuaQuhu'] = '驱虎',
    [':LuaQuhu'] = '出牌阶段限一次，荀彧可以与体力值大于自己的一名角色拼点：若荀彧赢，令该角色对其攻击范围内的另一名角色造成1点伤害；若荀彧没赢，其对荀彧造成1点伤害',
    ['luaquhu'] = '驱虎',
    ['LuaJieming'] = '节命',
    [':LuaJieming'] = '当荀彧受到1点伤害后，可以令一名角色摸两张牌，然后若其手牌数小于其体力上限，荀彧摸一张牌',
    ['ExSufei'] = '苏飞',
    ['&ExSufei'] = '苏飞',
    ['#ExSufei'] = '诤友投明',
    ['LuaZhengjian'] = '诤荐',
    ...
    ['LuaZhanyi'] = '战意',
    ['luazhanyi'] = '战意',
    [':LuaZhanyi'] = '出牌阶段限一次，你可以弃置一张牌并失去1点体力，根据牌的种类获得以下效果直到出牌阶段结束。\
