...
return {
    ...
    若其手牌数为全场最多，你减1点体力上限',
    ['luahuishi'] = '慧识',
    ['LuaHuishi-choose'] = '你可以选择一名角色获得这些牌',
    ['#addMaxHp'] = '%from 增加了 %arg 点体力上限',
    ['LuaTianyi'] = '天翊',
    ...
    ['#JieXiahoudun'] = '独眼的罗刹',
    ['LuaTanwu'] = '清俭',
    [':LuaTanwu'] = '<font color="green"><b>每回合限一次</b></font>，当你于摸牌阶段外获得牌后，你可将任意张手牌扣置于武将牌上；下个任意角色的结束阶段，你将这些牌交给其他角色，然后若你以此法交出的牌大于一张，则你摸一张牌',
    ['LuaTanwu-Storage'] = '你可以发动“清俭”，将任意张手牌置于武将牌上',
    ['LuaTanwu-Give'] = '你须发动“清俭”，将剩余的 %arg 张“清俭”牌交给其他角色',
    ['~LuaTanwu'] = '选择合适的牌→选择合适的目标→点击“确定”',
    ['luatanwusto'] = '清俭',
    ['luatanwugive'] = '清俭'
}
