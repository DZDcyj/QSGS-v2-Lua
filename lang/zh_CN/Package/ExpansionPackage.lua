...
return {
    ...
    ['#LuaZaoxianExtraTurn'] = '%from 的“<font color="yellow"><b>凿险</b></font>”被触发，将进行额外的一个回合',
    ['LuaJixi'] = '急袭',
    ...
    ['LuaTianjiang'] = '天匠',
    ['luatianjiang'] = '天匠',
    [':LuaTianjiang'] = '锁定技，限定技，游戏开始或回合开始时，你随机获得两张不同副类别的装备牌，并置入你的装备区。出牌阶段，你可以令一名其他角色获得你装备区里的一张牌并使用之',
    ['LuaZhuren'] = '铸刃',
    ['luazhuren'] = '铸刃',
    [':LuaZhuren'] = '出牌阶段限一次，你可以弃置一张手牌。根据此牌的花色点数，你有一定概率打造成功并获得一张武器牌（若打造失败或武器已有则改为摸一张牌。花色决定武器名称，点数决定成功率）此武器牌进入弃牌堆时，将其移出游戏',
    ['LuaZhurenPile'] = '天兵',
    ['#LuaZhurenSuccess'] = '%from 打造成功！',
    ['#LuaZhurenFailed'] = '%from 打造失败！'
}
