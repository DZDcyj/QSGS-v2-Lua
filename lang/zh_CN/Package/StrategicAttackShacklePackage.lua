...
return {
    ...
    ['#ExMouYujin'] = '威严毅重',
    ['LuaMouXiayuan'] = '狭援',
    [':LuaMouXiayuan'] = '每轮限一次，当其他角色受到伤害后，若此次伤害令其失去了全部的“护甲”，你可以弃置两张手牌，令其重新获得失去的“护甲”',
    ...
    ['luamoukejidis'] = '克己',
    -- 使用+会导致文本替换不成功
    [':LuaMouKeji'] = '①出牌阶段各限一次，你可以选择一项：1.弃置一张手牌，获得1点“护甲”；2.失去1点体力，获得2点“护甲”\
    ②你的手牌上限＋X（X为你的护甲值）\
    ③你使用的【桃】目标只能为处于濒死状态的自己',
    [':LuaMouKejiAwake'] = '①出牌阶段限一次，你可以选择一项：1.弃置一张手牌，获得1点“护甲”；2.失去1点体力，获得2点“护甲”\
    ②你的手牌上限＋X（X为你的护甲值）\
    ③你使用的【桃】目标只能为处于濒死状态的自己',
    ['LuaMouDujiang'] = '渡江',
    ...
    ['#ExMouHuanggai'] = '轻身为国',
    ['LuaMouKurou'] = '苦肉',
    [':LuaMouKurou'] = '①出牌阶段开始时，你可以交给一名其他角色一张牌。若你给出的牌为【桃】或【酒】，则你失去2点体力，否则你失去1点体力\
    ②当你失去1点体力后，你获得2点“护甲”',
    ['luamoukurou'] = '苦肉',
    ['@LuaMouKurou'] = '你可以发动“苦肉”，将一张牌交给其他角色并失去体力',
    ['~LuaMouKurou'] = '选择一张牌→选择一名其他角色→点击确定',
    ['LuaMouZhaxiang'] = '诈降',
