...
return {
    ...
    ['LuaChuhai'] = '除害',
    ['luachuhai'] = '除害',
    [':LuaChuhai'] = '使命技，出牌阶段限一次，你可以摸一张牌，并与一名角色拼点且你的拼点牌点数+X（X为4减去你装备区的装备数），\
    ...
    ['luapowei'] = '破围',
    ['@LuaPowei'] = '围',
    [':LuaPowei'] = '使命技，①游戏开始时，所有其他角色获得“围”标记；\
    ...
    ['LuaShenzhuo'] = '神著',
    [':LuaShenzhuo'] = '锁定技，当你使用非转化且非虚拟的【杀】结算结束后，你选择一项：1.摸一张牌，然后若此时是你的出牌阶段，你本阶段使用【杀】的次数上限+1；2.摸三张牌，然后你本回合不能再使用【杀】',
    ['LuaShenzhuo1'] = '摸一张牌，若在出牌阶段则本回合内使用【杀】次数+1',
    ['LuaShenzhuo2'] = '摸三张牌，然后本回合内不能再使用【杀】',
    ['ExShenSunce'] = '神孙策',
    ['&ExShenSunce'] = '神孙策',
    ['#ExShenSunce'] = '踞江鬼雄',
    ['LuaYingba'] = '英霸',
    ...
    ['@LuaPingding'] = '平定',
    ['LuaFuhai'] = '覆海',
    [':LuaFuhai'] = '锁定技，拥有“平定”标记的角色不能响应你对其使用的牌。当你使用牌指定有“平定”标记的角色为目标时，若本回合你以此法获得的牌数小于2，你摸一张牌。\
    当拥有“平定”标记的角色死亡时，你加X点体力上限并摸X张牌（X为其拥有的“平定”标记数）',
    ['LuaPinghe'] = '冯河',
    ['luapinghe'] = '冯河',
    [':LuaPinghe'] = '锁定技，你的手牌上限为你已损失的体力值。当你受到其他角色造成的伤害时，若你有手牌且体力上限大于1，你防止此伤害，然后你减1点体力上限并将一张手牌交给一名其他角色，\
    然后若你拥有“英霸”，你令伤害来源获得1个“平定”标记',
